                ...
                <div class="card mb-3">
                    <div class="child-profile">
                        <div class="child-photo">
                            ...
                            <?php else: ?>
                                <div style="width: 150px; height: 150px; background: #ddd; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                                    No Photo
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="child-info">
                            ...
                            <div class="info-grid">
                                <div class="info-item">
                                    ...
                                    <span class="info-value"><?php echo htmlspecialchars($child['student_id']); ?></span>
                                </div>
                                <div class="info-item">
                ...
                <div class="card mb-3">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">
                                <?php if ($current_location['battery_level']): ?>
                                    <?php echo $current_location['battery_level']; ?>%
                                    <?php if ($current_location['battery_level'] < 20): ?>
            ...
            <?php if (!empty($locations)): ?>
                ...
                locations.forEach(function(location, index) {
                    ...
                    marker.bindPopup(`
                        ...
                        Battery: ${location.battery_level || 'Unknown'}%<br>
