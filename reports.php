...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['generate_report'])) {
    ...
    if (empty($date_from) || empty($date_to)) {
        ...
        try {
            switch ($report_type) {
                case 'missing_cases':
                    $stmt = $pdo->prepare("SELECT mc.*, c.first_name, c.last_name, c.student_id, c.grade, c.photo,
                ...
                case 'location_tracking':
                    $stmt = $pdo->prepare("SELECT cl.*, c.first_name, c.last_name, c.student_id,
                ...
                case 'alerts':
                    $stmt = $pdo->prepare("SELECT a.*, c.first_name, c.last_name, c.student_id,
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php
                            try {
                                $stmt = $pdo->query("SELECT mc.*, c.first_name, c.last_name, c.student_id
                                                   FROM missing_cases mc
                                                   JOIN children c ON mc.child_id = c.id
                                ...
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <br>
                                            <small class="text-muted">
                                                ID: <?php echo htmlspecialchars($case['student_id']); ?> | 
