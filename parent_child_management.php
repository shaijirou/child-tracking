...
try {
    ...
    if ($search_child) {
        $where_conditions[] = "(c.first_name LIKE ? OR c.last_name LIKE ? OR c.student_id LIKE ?)";
        $params[] = "%$search_child%";
        $params[] = "%$search_child%";
        $params[] = "%$search_child%";
    }
    ...
    $stmt = $pdo->prepare("SELECT pc.id as relationship_id, 
                          ...
                          c.id as child_id, c.first_name, c.last_name, c.student_id, c.grade, c.photo,
    ...
    $stmt = $pdo->prepare("SELECT id, first_name, last_name, student_id, grade FROM children WHERE status = 'active' ORDER BY first_name, last_name");
    $stmt->execute();
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">
                                                    ID: <?php echo htmlspecialchars($rel['student_id']); ?><br>
                                ...
                                <select class="form-select" name="child_id" required id="childSelect">
                                    ...
                                    <?php foreach ($children as $child): ?>
                                        <option value="<?php echo $child['id']; ?>">
                                            <?php echo htmlspecialchars($child['first_name'] . ' ' . $child['last_name'] . ' (ID: ' . $child['student_id'] . ')'); ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
    ...
    if (childId) {
        ...
        if (child) {
            childDetails.innerHTML = `
                ...
                <strong>Student ID:</strong> ${child.student_id}<br>
