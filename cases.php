...
try {
    if ($_SESSION['role'] === 'admin' || $_SESSION['role'] === 'teacher') {
        $stmt = $pdo->query("SELECT mc.*, c.first_name, c.last_name, c.student_id, c.photo,
        ...
        $stmt = $pdo->prepare("SELECT mc.*, c.first_name, c.last_name, c.student_id, c.photo,
                              u1.full_name as reported_by_name,
                              u2.full_name as resolved_by_name
                              FROM missing_cases mc 
                              JOIN children c ON mc.child_id = c.id 
                                ...
                                <td>
                                    <div class="d-flex align-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <small><?php echo htmlspecialchars($case['student_id']); ?></small>
                                        </div>
                                    </div>
                                </td>
                                <td>
